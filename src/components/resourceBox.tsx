...
const ResourceBox = ({ heading, items }: Props) => {
  return (
    <div className="flex w-full lg:h-[8.6875rem] p-4 flex-col items-start gap-2 bg-[#263D2D] rounded-lg">
      <div className="flex w-full lg:w-[20rem] flex-col items-start gap-2">
